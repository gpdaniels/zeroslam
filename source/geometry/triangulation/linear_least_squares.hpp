...
#pragma once
#ifndef ZEROSLAM_GEOMETRY_TRIANGULATION_LINEAR_LEAST_SQUARES_HPP
#define ZEROSLAM_GEOMETRY_TRIANGULATION_LINEAR_LEAST_SQUARES_HPP
...
namespace geometry::triangulation {
    ...
    extern template class linear_least_squares<float>;
    extern template class linear_least_squares<double>;
}

#endif // ZEROSLAM_GEOMETRY_TRIANGULATION_LINEAR_LEAST_SQUARES_HPP
