...
# Find the main build file and all check, public header, source, test, and tool files.
GET_PROJECT_FILES(LICENSED_FILES
    "CMakeLists.txt"
    "checks/*"
    "include/*"
    "source/*"
...
FOREACH(LICENSED_FILE ${LICENSED_FILES})
    ...
    SET(LICENSE_REGEX_LINES
        "^/\\*$|^\"\"\"$|^#\\[\\[$"
        "^Copyright \\(C\\) ${LICENSE_YEAR} Geoffrey Daniels\\. https://gpdaniels\\.com/$"
        "^$"
        "^This program is free software: you can redistribute it and/or modify$"
        "^it under the terms of the GNU General Public License as published by$"
        "^the Free Software Foundation, version 3 of the License only\\.$"
